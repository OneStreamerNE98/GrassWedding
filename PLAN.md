...
## 6 · Image spec — exactly what Jason supplies
...
| Slot | File name | Aspect | Size (px) | Notes |
|---|---|---|---|---|
| Entrance hero | `hero.jpg` | 3:2 landscape | 2400×1600 | The one big photo. Engagement shot or the two of you; calm background, subject centered-ish (safe crop to 4:5 on mobile) |
| Entrance hero (mobile alt, optional) | `hero-portrait.jpg` | 4:5 portrait | 1600×2000 | Only if the landscape crop loses the subject |
| The Wedding — venue | `venue.jpg` | 3:2 | 2000×1333 | The Barnes exterior or Parkway; can be a licensed/own photo |
| Ceremony label card (optional) | `ceremony.jpg` | 1:1 | 1200×1200 | Detail shot (rings, invitation, flowers) |
| Reception label card (optional) | `reception.jpg` | 1:1 | 1200×1200 | Detail shot |
| Travel card (optional) | `philly.jpg` | 3:2 | 2000×1333 | Skyline/Parkway photo replaces any drawn skyline |
| Registry note (optional) | `registry.jpg` | 1:1 | 1200×1200 | Small; e.g. the dogs |
| OG/share image | *(generated by agent from `hero.jpg`)* | 1.91:1 | 1200×630 | Auto-composited with names + date; also 2400×1260 export |
| Our Story (future) | `story-01.jpg` … `story-NN.jpg` | any | 1600 long edge | Whenever ready — unlocks the hidden Story/Gallery exhibitions; captions supplied as a simple list |
...
| **P4 — Media** | Jason's photos in per §6; OG image composited; hidden Story/Gallery unlocked only if photos provided | LCP < 2.5s on 4G profile; CLS ≈ 0 |
